...
use App\Jobs\CatalystSyncIdeafestReportFromGSheetJob;
use App\Services\SettingService;
use Illuminate\Console\Command;
use Revolution\Google\Sheets\Facades\Sheets;

class CatalystSyncIdeafestReporting extends Command
{
    /**
     ...
     * @var string
     */
    protected $description = 'Sync Catalyst Ideafest Reporting.';
    ...
    public function handle(SettingService $settingService)
    {
        ...
        dispatch(new CatalystSyncIdeafestReportFromGSheetJob($sheet));
    }
