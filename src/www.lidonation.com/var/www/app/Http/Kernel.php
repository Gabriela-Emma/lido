...
use App\Http\Middleware\AuthenticateReward;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'auth.reward' => AuthenticateReward::class,
        ...
        'duplicateAccount' => \App\Http\Middleware\DuplicateAccount::class,
        'registrationStopped' => \App\Http\Middleware\RegistrationControlled::class,
