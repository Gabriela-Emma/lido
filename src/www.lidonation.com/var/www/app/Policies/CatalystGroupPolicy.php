...
class CatalystGroupPolicy extends AppPolicy
{
     ...
     * @throws \Exception
     */
    public function view(User $user, Group $CatalystGroup): bool
    {
     ...
     */
    public function update(User $user, Group $CatalystGroup): bool
    {
     ...
     */
    public function delete(User $user, Group $CatalystGroup): bool
    {
