    ...
    ->group(function () {
        ...
        Route::prefix('proposals')->group(
            function () {
                ...
                Route::get('/{proposal:id}', [CatalystExplorer\ProposalController::class, 'proposal'])->name('proposal');
                Route::get('/{proposal:id}/fund', [CatalystExplorer\FundController::class, 'proposalFund'])->name('proposals.fund');
