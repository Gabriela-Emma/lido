                    ...
                    <section class="p-6">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <Link class="text-teal-800" method="post" :href="route('catalyst-explorer.createBallot')">
                                    Create Draft Ballot
                                </Link>
                            </div>
                        </div>
...
import ProgressSpinner from "@apps/catalyst-explorer/Components/Global/ProgressSpinner.vue";
