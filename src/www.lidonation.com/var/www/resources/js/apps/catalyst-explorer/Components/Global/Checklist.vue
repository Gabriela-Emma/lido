<template>
    <div class="flex-wrap px-2 pb-2 overflow-scroll max-h-80">
        <div class="border-t"></div>
        <p class="sticky top-0 w-full pl-3 mb-3 text-gray-400 bg-white">Limit to {{ propName }}</p>
        <TransitionRoot :show="!!currentInstance.options.length" enter-active-class="transition duration-300 ease-out" enter-from-class="transform scale-95 opacity-0"
            ...
            <div class="flex items-center mb-4 ml-2" v-for="item in currentInstance.options">
                ...
                <label for="default-checkbox" class="font-medium text-gray-900 ms-2 dark:text-gray-300">
