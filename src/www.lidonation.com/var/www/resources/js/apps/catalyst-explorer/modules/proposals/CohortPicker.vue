<template>
    <div
        class="w-full">
        <Multiselect
            placeholder="Community Cohort"
            v-model="selectedRef"
            :options="filters"
            :classes="{
                container: 'multiselect border-0 px-1 py-2 flex-wrap',
                dropdown: 'multiselect-dropdown border-transparent shadow-md',
                containerActive: 'shadow-none shadow-transparent box-shadow-none border-0',
