...
import YesNoVotesSum from "@apps/catalyst-explorer/modules/charts/YesNoVotesSum.vue";
import VotesCastBreakdown from '@apps/catalyst-explorer/modules/charts/VotesCastBreakdown.vue';
...
const LiveTally = defineAsyncComponent(() =>
    import('@apps/catalyst-explorer/modules/charts/LiveTally.vue')
)
...
const TopFundedTeams = defineAsyncComponent(() => import('@apps/catalyst-explorer/modules/charts/TopFundedTeams.vue'));
const TopFundedProposals = defineAsyncComponent(() => import('@apps/catalyst-explorer/modules/charts/TopFundedProposals.vue'));
...
function getMetrics() {
    ...
    // fetch adaRanges
    axios.get(route('catalyst-explorer.metrics.adaPowerRanges'), { params })
        .then((res) => {
...
function getAttachmentLink() {
    ...
    axios.get(route('catalyst-explorer.attachments.votingPowers'), { params })
