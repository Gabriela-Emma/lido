...
function query() {
    ...
    axios.get(route('catalyst-explorer.metrics.votesCastAverage'), { params })
        .then((res) => {
    ...
    axios.get(route('catalyst-explorer.metrics.votesCastMode'), { params })
        .then((res) => {
    ...
    axios.get(route('catalyst-explorer.metrics.votesCastMedian'), { params })
        .then((res) => {
    ...
    axios.get(route('catalyst-explorer.metrics.totalRegisteredAndVoted'), { params })
        .then((res) => {
    ...
    axios.get(route('catalyst-explorer.metrics.totalRegisteredAndNeverVoted'), { params })
        .then((res) => {
    ...
    axios.get(route('catalyst-explorer.metrics.votesCastRanges'), { params })
        .then((res) => {
