        ...
        <div class="container">
            <div class="lg:grid lg:grid-cols-12 lg:gap-x-5">
                ...
                <div class="space-y-6 sm:px-6 lg:col-span-9 xl:col-span-10">
                    <div
                        class="relative flex flex-col w-full  p-4 mt-8 border sm:col-span-2 border-slate-200 bg-white rounded-sm">
                            ...
                            <div>
                                ...
                                <div class="flex gap-4 text-slate-400">
                                    ...
                                    <div class="flex gap-1">
                                        ...
                                        <div class="font-semibold text-slate-900">- {{ $filters.currency(totalAwarded) }}
                                        </div>
                                    </div>
                                    <div class="flex gap-1">
                                        <div>{{ $t("Total Received") }}</div>
                                        <div class="font-semibold text-slate-900">- {{ $filters.currency(totalReceived) }}
                                        </div>
                                    </div>
                                    <div class="flex gap-1">
                                        <div>{{ $t("Funding Remaining") }}</div>
                                        <div class="font-semibold text-slate-900">- {{ $filters.currency(totalRemaining) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="relative flex w-full gap-8 p-4 mt-8 border sm:col-span-2 border-slate-200 bg-white rounded-sm"
                        v-if="!!group?.id">
                        <div class="w-full">
                            <div class="bg-white px-2 text-lg font-semibold leading-6 xl:text-xl f text-slate-900">
                                {{ $t("The Team") }}
                            </div>
                                ...
                                <div class="justify-end w-full mb-4">
                                    <div v-if="group.id != null" class="flex flex-row items-center justify-end">
                                        ...
                                        <div class="flex flex-row items-center flex-shrink-0">
                                            <button v-if="saveButton" @click.prevent="addMember"
                                            ...
                                            <button v-if="!saveButton" @click.prevent="saveButton = !saveButton"
                            ...
                            <div class="flex flex-row justify-between">
                                ...
                                <div class="flex flex-row justify-between w-1/2">
                                    <div class="flex flex-row items-center w-1/3">
                                        <button v-if="selectedRef.length > 0" @click.prevent="addProposal()"
                                            class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-teal-600 border border-transparent rounded-sm shadow-sm hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2">
                                            <span class="flex items-center justify-between ">
                                    ...
                                    <div v-if="links.length > 0">
                                        <div class="flex justify-between w-full gap-16 my-16 xl:gap-24">
                                            <div class="flex-1 w-full px-6">
                                                <Pagination :links="links" :total="total" :from="from" :to="to"
                                                    :per-page="perPageRef"
...
import ProposalPicker from "@apps/catalyst-explorer/modules/proposals/ProposalPicker.vue";
import PersonPicker from "@apps/catalyst-explorer/modules/people/PersonPicker.vue";
