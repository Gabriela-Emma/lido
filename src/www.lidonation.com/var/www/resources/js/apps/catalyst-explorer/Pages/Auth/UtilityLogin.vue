                                                ...
                                                <div class="p-6 bg-white rounded shadow-sm w-96">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="flex items-end justify-between ">
                                                            ...
                                                            <span class="text-sm">
                                                                <Link :href="route('catalyst-explorer.register')" class="font-bold text-teal-600 hover:text-teal-500" preserve-scroll >{{ $t('Register') }}</Link>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
...
import ModalProps from "@apps/catalyst-explorer/models/props";
