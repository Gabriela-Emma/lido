...
import HeaderComponent from "@apps/earn/Components/Global/HeaderComponent.vue";
...
createInertiaApp({
    ...
    // @ts-ignore
    // resolve: (name) => resolvePageComponent(`./earn/Pages/${name}.vue`, import.meta.glob('../earn/Pages/**/*.vue')),
    resolve: name => {
        const pages = import.meta.glob('../earn/Pages/**/*.vue', { eager: true });
