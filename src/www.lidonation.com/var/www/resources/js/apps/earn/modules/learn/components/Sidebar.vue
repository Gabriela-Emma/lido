<template>
    <section class="sticky flex flex-col w-full gap-8 top-1">
        ...
        <a class="flex flex-col gap-4 p-4 border-8 border-labs-black round-sm">
...
const Promo = defineAsyncComponent(() => import('@/global/Components/Promo.vue'));
const Delegate = defineAsyncComponent(() => import("@/global/Components/Delegate.vue"));


const user = computed(() => usePage().props.ziggy.user as User);
