<template>
    <section class="sticky flex flex-col w-full gap-8 top-1">
        <div class="p-4 border-8 rounded-sm border-labs-red">
            ...
            <div class="p-2 bg-labs-black rounded-sm mt-4 hover:bg-labs-red" v-if="!learnerData.wallet_address || !learnerData.wallet_stake_address">
        ...
        <div class="p-4 text-white border-8 rounded-sm border-labs-red bg-labs-red"
            ...
            <div v-if="learnerData?.nextLesson"
                 class="flex flex-col gap-4 px-2 py-3 mt-4 border-t border-labs-black/20">
