    ...
    <div class="flex w-full h-full rounded-l-sm">
        <div class="relative flex-grow w-full h-full focus-within:z-10 overflow-hidden">
            ...
            <input name="searchProposals" id="searchProposals" placeholder="Search title, proposal detail, or (co)authors" v-model="search"
                   ...
                   class="block sm:text-sm sm:leading-5 w-full border-white h-full pl-10 transition duration-150 ease-in-out border-4 border-r-0 rounded-l-sm form-input focus:bg-teal-500 focus:text-white focus:border-teal-500 focus:outline-none"/>

            <div class="absolute inset-y-0 right-0 flex items-center px-3 border-x">
