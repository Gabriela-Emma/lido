<template>
    <div v-if="search && voterData?.data?.length === 0">
        <p>
            ...
            <div class="sm:flex-auto">
                <div class="flex flex-col gap-2 text-gray-700">
                    ...
                    <p>
                        ...
                        <a href="https://docs.projectcatalyst.io/catalyst-basics/voting/how-to-audit-the-vote/voting-ledger-snapshots" target="_blank">
                            snapshots
                        </a> provided by the iog catalyst team.

                        To produce this list we, then we run your voting key through this
                        <a href="https://github.com/input-output-hk/catalyst-core/blob/main/src/audit/src/find/README.md" target="_blank">tool</a>.
                    </p>
                </div>
            </div>
        </div>
...
let query = () => {
    ...
    axios.get(route('catalystExplorer.voterData'), {params}).then((res) => {
