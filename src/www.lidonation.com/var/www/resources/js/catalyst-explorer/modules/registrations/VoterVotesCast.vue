        ...
        <div class="flex items-center gap-4 rounded-sm">
            <div class="sm:flex-auto">
                <div class="flex flex-col gap-2 text-gray-700">
                    ...
                    <p>
                        Voting history data was generated by jormungandr sidechain snapshot provided by the iog catalyst team.
                        To produce this list we, then we run your voting key through this tool: https://github.com/input-output-hk/catalyst-core/blob/main/src/audit/src/find/README.md
                    </p>
                </div>
            </div>
        </div>
