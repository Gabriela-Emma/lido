    ...
    <section class="relative bg-gray-100">
        <div class="container py-8">
            <div class="grid h-full grid-cols-1 grid-rows-1 gap-4 md:grid-cols-3 xl:grid-cols-8 xl:grid-rows-10">
                <div class="relative col-span-1 xl:col-span-2 row-span-1 px-3 py-5 bg-teal-600 round-sm">
                ...
                <!-- Live Tally -->
                <div
                    class="w-full col-span-1 p-3 overflow-y-visible bg-white md:col-span-3 xl:col-span-6 xl:row-span-12 round-sm">
