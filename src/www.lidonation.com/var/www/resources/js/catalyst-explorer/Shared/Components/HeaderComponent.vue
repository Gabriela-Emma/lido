    ...
    <header class="py-10 container flex flex-wrap gap-4 items-center">
        ...
        <div class="xl:ml-auto flex flex-col gap-1" v-if="!!user">
            ...
            <ul class="flex gap-4 justify-end items-center">
                <li>
                    <Link class="flex gap-1 items-center" :href="$utils.localizeRoute('catalyst-explorer/dashboard')">
                ...
                <li>
                    <Link class="flex gap-1 items-center text-teal-600 font-bold hover:text-red-600" href="/api/catalyst-explorer/logout" method="POST" as="button">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
