<template>
    <div class="relative z-40 h-full pb-20" >
            ...
            <div class="w-full h-full">
                <form method="POST" class="w-full h-full" @submit.prevent>
                    <div class="flex flex-col justify-between h-full gap-1">
                        <label for="search"
                            class="block px-3 pt-2 font-medium font-semibold text-gray-900 text-md">Search</label>
                        <input type="search" onkeydown="return (event.keyCode!=13);" name="search" id="search"
        ...
        <div class="p-6" x-show="!results && noResults">
            <div
                ...
                <span class="block mt-2 text-sm font-medium text-gray-900">
                    Nothing came up for
                    <span class="font-semibold" x-text="search"></span>
                </span>
            </div>
        </div>
    </div>
