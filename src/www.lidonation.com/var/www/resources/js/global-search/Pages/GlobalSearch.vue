<template>
    <div v-if="open">
        <div class="absolute top-0 bottom-0 right-0 z-40 w-3/4 pb-20 bg-white shadow lg:w-2/5 sm:w-1/2 md:w-3/5">
            ...
            <nav class="h-full overflow-y-auto" aria-label="Directory" v-show="results">
                                ...
                                <li class="bg-white" >
                                    <div
                                        ...
                                        <div class="flex-shrink-0">
                                            <img class="w-10 h-10 bg-teal-800 rounded-full" alt="" />
                                        </div>
            ...
            <div class="absolute w-full p-8 top-20 h-50"  v-show="working">
            ...
            <div class="p-6" v-show="!results && noResults">
                <div
