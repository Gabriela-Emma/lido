        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex items-center flex-shrink-0">
                    <a href="{{ localizeRoute('portal') }}">
                        <img class="block logo" width="60" height="60"
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ localizeRoute('portal') }}" :active="request()->routeIs('portal')">
                        {{ $snippets->portal }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ localizeRoute('phuffycoin') }}" :active="request()->routeIs('phuffycoin')">
                        {{ $snippets->phuffyCoin }}
                    </x-jet-nav-link>
                </div>
            </div>
                            ...
                            <x-slot name="trigger">
                                <span class="inline-flex rounded-md">
                                    <button type="button"
                                        ...
                                        <svg class="-mr-0.5 ml-2 w-4 h-4" xmlns="http://www.w3.org/2000/svg"
