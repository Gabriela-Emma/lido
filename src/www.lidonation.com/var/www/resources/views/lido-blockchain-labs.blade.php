<x-public-layout class="lbl labs" metaTitle="LIDO Blockchain Labs">
        ...
        <div class="container">
            ...
            <div class="flex flex-col items-center gap-4 w-full">
                <ul class="justify-center flex flex-wrap gap-y-1.5 gap-x-2 flex-row list-outside text-2xl max-w-2xl text-white z-20 relative">
                    <li class="inline-flex items-center break-words inline box-decoration-clone leading-none bg-labs-green rounded-sm px-2.5 py-2">
                        <svg class="mr-1.5 h-2 w-2 text-red-400" fill="currentColor" viewBox="0 0 8 8">
                            <circle cx="4" cy="4" r="3"/>
                        </svg>
                        Developer Mentorship
                    </li>
                    <li class="inline-flex items-center break-words inline box-decoration-clone leading-none bg-labs-yellow-light rounded-sm px-2.5 py-2 text-slate-800">
                        <svg class="mr-1.5 h-2 w-2 text-red-400" fill="currentColor" viewBox="0 0 8 8">
                            <circle cx="4" cy="4" r="3"/>
                        </svg>
                        Swahili + English technical translation
                    </li>
                    <li class="inline-flex items-center break-words inline box-decoration-clone leading-none bg-labs-red-light rounded-sm px-2.5 py-2">
                        <svg class="mr-1.5 h-2 w-2 text-red-400" fill="currentColor" viewBox="0 0 8 8">
                            <circle cx="4" cy="4" r="3"/>
                        </svg>
