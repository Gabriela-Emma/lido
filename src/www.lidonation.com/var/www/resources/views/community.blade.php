<x-public-layout class="community" metaTitle="LIDO Nation Community">
    <x-public.page-header :size="'md'">
        <x-slot name="title">
            <span class='block font-thin'>{{__('LIDO Nation') }}</span>
...
{{--    <section class="relative z-10 py-8 text-white bg-teal-600">--}}
{{--        <div class="container">--}}
{{--            <h2 class="flex flex-row flex-wrap items-baseline gap-4 lg:text-4xl">--}}
{{--                <span>Follow Us on Social Media</span>--}}
{{--                <a class="flex flex-row items-baseline gap-1 text-base text-teal-600 hover:text-white" href="//facebook.com/lidonation" target="_blank">--}}
{{--                    <span class="w-5 h-5">--}}
...
{{--                </a>--}}
{{--                <a class="flex flex-row items-baseline gap-1 text-base text-teal-600 hover:text-white" href="//twitter.com/lidonation" target="_blank">--}}
{{--                    <span class="relative w-5 h-5 top-1">--}}
{{--                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">--}}
...
{{--                </a>--}}
{{--            </h2>--}}
{{--            <div class="grid gap-8 mt-6 lg:grid-cols-2 md:gap-16">--}}
{{--                <div class="max-h-[24rem] overflow-y-scroll border-t border-b border-gray-300">--}}
{{--                    @foreach($tweets as $tweet)--}}
{{--                        <div class="p-3 -mt-px border border-gray-300">--}}
{{--                            <div class="flex flex-row">--}}
{{--                                <div>--}}
{{--                                    <div class="flex-shrink-0 w-8 mr-3 sm:w-12">--}}
...
{{--                                            <div>--}}
{{--                                                <span class="flex w-8 h-8 bg-teal-800 rounded-full ring-8 ring-white">--}}
{{--                                                  @include('svg.night')--}}
{{--                                                </span>--}}
{{--                                            </div>--}}
...
{{--                                        <div class="relative flex space-x-4">--}}
{{--                                            <div>--}}
{{--                                                <div class="flex w-8 h-8 text-yellow-500 bg-teal-400 rounded-full ring-8 ring-white">--}}
{{--                                                  @include('svg.sunrise')--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                            <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">--}}
...
{{--        </div>--}}
{{--    </section>--}}
{{--    <section class="relative py-16 bg-scroll bg-center bg-cover bg-pool-bw-light bg-teal-light-500 bg-blend-color-burn" aria-labelledby="quick-links-title">--}}
{{--        <div class="container">--}}
