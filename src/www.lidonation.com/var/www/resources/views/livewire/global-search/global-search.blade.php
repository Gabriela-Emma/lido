...
<div class="h-full pb-4">
    ...
    <div>
        <div class="mx-auto border-b-2 border-gray-400 flex justify-evenly items-center w-5/6 px-6 py-4">
            ...
            <button wire:click="setNews" class="{{ $selectedType === 'news' ? 'border-b-2 border-gray-900' : '' }}">News
                <span class="bg-gray-100 px-1 py-0.5 rounded-full">{{ count($newsItems) }}</span></button>
