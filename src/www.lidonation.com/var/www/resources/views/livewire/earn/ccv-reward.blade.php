<div>
    ...
    <div x-show="walletLoaded" x-transition class="flex flex-col items-center justify-center gap-4">
        ...
        <div class="text-center" x-show="eligible === 'true'">
            <h2 class="text-center" x-show="(!rewards || rewards.length === 0) && withdrawalCardanoScanLinks.length === 0">Thanks for voting! Claim your voting rewards.</h2>
            <h2 class="text-center" x-show="rewards.length > 0 && withdrawalCardanoScanLinks.length === 0">Thanks for voting! Rewards have been issued to your account.</h2>
            <h2 class="text-center" x-show="(!rewards || rewards.length === 0) && withdrawalCardanoScanLinks.length > 0">Thanks for voting! See your withdrawal details.</h2>
            <h2 class="text-center" x-show="rewards.length > 0 && withdrawalCardanoScanLinks.length > 0">Thanks for voting! See your pending rewards and already withdrawn transaction details.</h2>
            <div class="flex flex-col items-centre w-full gap-8">
                ...
                <div class="flex flex-col gap-8 justify-center items-center w-auto">
                    <button type="button"
