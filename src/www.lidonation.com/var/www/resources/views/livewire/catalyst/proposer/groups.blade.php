<div class="relative z-10 catalyst-proposals-research-wrapper">
    ...
    <x-public.page-header :size="'md'">
        <x-slot name="title">
            <span class="z-20 flex flex-col gap-3 sm:flex-row">
            ...
            <div class="relative space-y-12">
                <div class="bg-white/[0.98] w-full h-full absolute z-30 space-y-4" x-show="showPane" x-transition>
                    ...
                    <div class="text-xl xl:text-2xl 2xl:text-3xl">
                        <b class="mb-2 text-3xl">Two Simple Steps:</b>
                ...
                <div
                    ...
                    class="absolute top-0 left-0 z-10 flex items-center justify-center hidden w-full h-full space-y-4  bg-white-100">
                    <div
                    ...
                    <div>
                        <div class="relative p-2 mb-2 border" x-data="{
                            ...
                            <div class="flex flex-row flex-wrap gap-2 -mt-5 font-semibold">
                                ...
                                <span
                                    class="inline-flex ml-4 text-sm italic font-medium xl:ml-8 2xl:ml-16 hover:cursor-pointer hover:text-teal-600"
                        ...
                        <div
                            @click="showPane = !showPane"
                            class="ml-auto text-sm font-semibold text-right text-teal-600 hover:cursor-pointer hover:text-yellow-800">
                            How is this data calculated?
                        </div>
                    </div>
                </div>
                                ...
                                <div class="items-end w-full space-y-2 xl:flex xl:items-center xl:justify-between">
                                    <div class="space-y-1 text-lg font-medium leading-6">
                                        ...
                                        <div class="flex flex-col justify-center gap2 itemscenter">
                                            ...
                                            <span class="text-xs text-gray-500">Awarded</span>
                                        </div>
                                    </div>

                                    <ul role="list"
                                        class="relative flex flex-wrap items-center justify-start max-w-xs space-x-2 xl:top-4">
