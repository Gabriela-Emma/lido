            ...
            <footer>
                <div class="flex flex-row justify-center gap-3 py-6 bg-gray-200" x-data="voterTool">
                    <button type="button"
                        ...
                        class="inline-flex items-center gap-2 px-4 py-2 text-lg font-medium text-gray-700 bg-white border border-gray-300 rounded-sm shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent-500">
                        <span x-show="!has({{$proposal->id}})">Bookmark</span>
                        <span x-show="has({{$proposal->id}})">Bookmarked</span>
                        <svg  x-show="has({{$proposal->id}})" class="w-5 h-5 mr-2 -ml-1 text-pink-600"
                             xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                            <path x-show="proposals.length > 0" d="M5 4a2 2 0 012-2h6a2 2 0 012 2v14l-5-2.5L5 18V4z"/>
                        </svg>
                    ...
                    <button type="button"
                        ...
                        class="inline-flex items-center gap-2 px-4 py-2 text-lg font-medium text-gray-700 bg-white border border-gray-300 rounded-sm shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500">
