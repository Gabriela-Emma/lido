<x-public-layout class="library" title="Financial Details">
    <x-public.page-header :size="'md'">
        <x-slot name="title">
            <div class="block z-10 flex flex-col sm:flex-row gap-3">
                <span class='font-light z-10'>{{__('Financial') }}</span>
                <span class='font-black z-10 text-teal-600'>{{__('Details') }}</span>
            </div>
        </x-slot>
        <div>
            <p>
    ...
    <section class="bg-teal-600 text-white py-8 z-10 relative">
        <div class="container">
            <div class="flex flex-col-reverse md:flex-row gap-16 items-center 2xl:pr-80">
                <div class="w-1/4 x-auto md:w-[12rem]">
                    @include('svg.gears')
                </div>
                <div>
            ...
            <div class="flex flex-col-reverse md:flex-row gap-16 items-center 2xl:pr-80">
                <div>
                    <p>
                        ...
                        Visit the <a class="text-accent-400 hover:text-white" href="{{localizeRoute('purpose-driven-pool')}}">PURPOSE</a> page to learn more,
                        get registered, and vote!
                    </p>
                    <p>
                        <strong>
                            One quarter of our margin supports content and enhancements that enrich the Lido Nation delegator experience.
                        </strong>
                        This may include producing new content, expanding available translations, and other projects that we dream up together!
                    </p>
                    <p>
                        The remaining quarter is what makes this a "real job" for our pool operators and staff.
                        <strong>Thanks for being a part of our vision to build a company that can do well, and do good.</strong>
                    </p>
                </div>
