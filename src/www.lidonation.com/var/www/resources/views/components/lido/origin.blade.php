        ...
        <div class="flex flex-row flex-wrap text-slate-50 font-bold justify-around">
            ...
            <div class="p-2">
                <div
                    ...
                    <div class="inline-flex flex-col items-center justify-center">
                        <div class="text-4xl inline-block font-bold">
                            <x-public.animated-number :number="App\Models\Insight::count()"
            ...
            <div class="p-2">
                <div
                    ...
                    <div class="inline-flex flex-col items-center justify-center">
                        <div class="text-4xl inline-block font-bold">
                            <x-public.animated-number :number="540"
                ...
                <div
                    ...
                    <div class="inline-flex flex-col items-center justify-center">
                        <div class="text-3xl inline-block font-bold">
                            <x-public.animated-number :number="12600"
            ...
            <div class="p-2">
                <div
                    ...
                    <div class="inline-flex flex-col items-center justify-center">
                        <div class="text-3xl inline-block font-bold">
                            <x-public.animated-number :number="3500"
                ...
                <div
                    ...
                    <div class="inline-flex flex-col items-center justify-center">
                        <div class="text-5xl inline-block font-bold">
                            <x-public.animated-number :number="12"
