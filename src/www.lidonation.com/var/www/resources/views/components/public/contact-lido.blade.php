<div class="relative bg-white rounded-sm">
    <h2 class="sr-only">Contact us</h2>

    <div class="grid grid-cols-1 lg:grid-cols-3">
        <!-- Contact information -->
        <div class="relative overflow-hidden py-10 px-6 bg-teal-600 sm:px-10 xl:p-12">
            ...
            <p class="mt-6 text-base text-teal-50 max-w-3xl">
                Drop us a line via your favorite communication channel and someone from the team will respond
            ...
            <dl class="mt-8 space-y-6">
                ...
                <dd class="flex text-base text-teal-50">
                    ...
                    <span class="ml-3">hello@lidonation.com</span>
                </dd>
            </dl>
            <ul class="mt-8 flex space-x-12" role="list">
                <li>
                    <a class="text-teal-200 hover:text-teal-100"
                       href="https://www.facebook.com/lidonation" target="__blank">
                ...
                {{--                        </li>--}}
                <li>
                    <a class="text-teal-200 hover:text-teal-100" href="https://twitter.com/LidoNation"
                       target="__blank">
        ...
        @if(old())
            <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                Success!
                <p>Someone from the team will respond in 24 to 48 hours.</p>
            </div>
        @else
            <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                ...
                <form action="{{route('contact')}}" method="POST"
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="email" name="email" type="email" autocomplete="email" class="">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="text" name="phone" id="phone" autocomplete="tel" class=""
                    ...
                    <div class="sm:col-span-2 sm:flex sm:justify-end mt-2">
                        <div class="recaptcha my-2">
