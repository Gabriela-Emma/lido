                ...
                <div class="mb-3">
                    <div class="flex flex-row items-end justify-between gap-3">
                        <div class="grid flex-1 h-6 bg-teal-300 rounded-sm grid-cols-100">
                            <div class="h-6 p-1 text-xs font-semibold bg-teal-800 rounded-sm text-teal-light-500" style="grid-column: span {{$data['percent']}} / span {{$data['percent']}}">{{$key}}</div>
                        </div>
                        <div>
            ...
            <div class="flex flex-row flex-nowrap justify-start p-1 overflow-x-scroll categories">
                <div class="border border-teal-600 -mt-px -ml-px inline-flex flex-col gap-6 justify-between border-opacity-50 p-4 min-w-15 md:min-w-[13rem] xl:min-w-[initial]">
                    ...
                    <div class="flex w-full min-w-full overflow-hidden">
                        ...
                        <div class="relative w-full xl:w-48">
                            <x-catalyst.users.chart-per-fund :labels="$allTimeCompletedPerRound->labels" :data="$allTimeCompletedPerRound->data"></x-catalyst.users.chart-per-fund>
                        </div>
                        @else
                ...
                <div class="border border-teal-600 -mt-px -ml-px inline-flex flex-col gap-6 justify-between border-opacity-50 p-4 min-w-15 md:min-w-[13rem] xl:min-w-[initial]">
                    ...
                    <div class="flex w-full min-w-full overflow-hidden">
                        ...
                        <div class="relative w-full xl:w-48">
                            <x-catalyst.users.chart-per-fund :labels="$allTimeFundedPerRound->labels" :data="$allTimeFundedPerRound->data"></x-catalyst.users.chart-per-fund>
                        </div>
                        @else
                        <div class="inline-flex min-w-[11rem]">
                            <div class="relative z-0 inline-flex rounded-md shadow-sm">
                ...
                <div class="border border-teal-600 -mt-px -ml-px inline-flex flex-col gap-6 justify-between border-opacity-50 p-4 min-w-15 md:min-w-[13rem] xl:min-w-[initial]">
                    ...
                    <div class="flex w-full min-w-full overflow-hidden">
                        ...
                        <div class="relative w-full xl:w-48">
                            <x-catalyst.users.chart-per-fund :labels="$allTimeProposedPerRound->labels" :data="$allTimeProposedPerRound->data"></x-catalyst.users.chart-per-fund>
                        </div>
                        @else
                        <div class="inline-flex min-w-[11rem]">
                            <div class="relative z-0 inline-flex rounded-md shadow-sm">
                ...
                @if($allTimeFundingPerRound->dataUsd?->sum() > 0)
                <div class="border border-teal-600 -mt-px -ml-px inline-flex flex-col gap-6 justify-between border-opacity-50 p-4 min-w-15 md:min-w-[13rem] xl:min-w-[initial]">
                    <div class="flex flex-row flex-no-wrap items-center justify-between gap-4 md:justify-start">
                        <div class="flex flex-wrap font-semibold leading-2">
                            <span class="text-xl font-semibold xl:text-3xl leading-2 text-blue-dark-500">
                                ${{ humanNumber($allTimeFundingPerRound->dataUsd?->sum()) }}
                            </span>
                        </div>
                    ...
                    <div class="w-full min-w-full overflow-hidden">
                        @if( $allTimeFundingPerRound->dataUsd?->count() > 1 )
                        <div class="relative w-full xl:w-48">
                            <x-catalyst.users.chart-per-fund dataType="currency" :labels="$allTimeFundingPerRound->labels" :data="$allTimeFundingPerRound->dataUsd"></x-catalyst.users.chart-per-fund>
                        </div>
                        @else
                ...
                <div class="border border-teal-600 -mt-px -ml-px inline-flex flex-col gap-6 justify-between border-opacity-50 p-4 min-w-15 md:min-w-[13rem] xl:min-w-[initial]">
                    <div class="flex flex-row flex-no-wrap items-center justify-between gap-5 md:justify-start text-blue-dark-500">
                        <div class="flex flex-wrap font-semibold flex-nowrap leading-2">
                            <span class="text-xl font-semibold xl:text-3xl leading-2">
                                ${{ humanNumber($allTimeAwardedPerRound->dataUsd?->sum()) }}
                            </span>
                        </div>
                        <div class="flex flex-wrap gap-1 text-sm font-normal flex-nowrap leading-2">
                            <span>
                    ...
                    <div class="w-full min-w-full overflow-hidden">
                        @if( $allTimeAwardedPerRound->dataUsd?->count() > 1 )
                        <div class="relative w-full xl:w-48">
                            <x-catalyst.users.chart-per-fund dataType="currency" :labels="$allTimeAwardedPerRound->labels" :data="$allTimeAwardedPerRound->dataUsd"></x-catalyst.users.chart-per-fund>
                        </div>
                        @else
                        <div class="inline-flex min-w-[10rem]">
                            <div class="relative z-0 inline-flex rounded-md shadow-sm">
                ...
                <div class="border border-teal-600 -mt-px -ml-px inline-flex flex-col gap-6 justify-between border-opacity-50 p-4 min-w-15 md:min-w-[13rem] xl:min-w-[initial]">
                    <div class="flex flex-row flex-no-wrap items-center justify-between gap-5 md:justify-start text-blue-dark-500">
                        <div class="flex flex-wrap font-semibold flex-nowrap leading-2">
                            <span class="text-xl font-semibold xl:text-3xl leading-2">
                                ${{humanNumber($allTimeReceivedPerRound->dataUsd?->sum())}}
                            </span>
                        </div>
                        <div class="flex flex-wrap gap-1 text-sm font-normal flex-nowrap leading-2">
                            <span>
                    ...
                    <div class="w-full min-w-full overflow-hidden">
                        @if( $allTimeReceivedPerRound->dataUsd?->count() > 1 )
                        <div class="relative w-full xl:w-48">
                            <x-catalyst.users.chart-per-fund dataType="currency" :labels="$allTimeReceivedPerRound->labels" :data="$allTimeReceivedPerRound->dataUsd"></x-catalyst.users.chart-per-fund>
                        </div>
                        @else
                        <div class="inline-flex min-w-[10rem]">
                            <div class="relative z-0 inline-flex rounded-md shadow-sm">
                ...
                @endif
                @if($allTimeFundingPerRound->dataAda?->sum() > 0)
                <div class="border border-teal-600 -mt-px -ml-px inline-flex flex-col gap-6 justify-between border-opacity-50 p-4 min-w-15 md:min-w-[13rem] xl:min-w-[initial]">
                    <div class="flex flex-row flex-no-wrap items-center justify-between gap-4 md:justify-start">
                        <div class="flex flex-wrap font-semibold leading-2">
                            <span class="text-xl font-semibold xl:text-3xl leading-2 text-blue-dark-500">
                                ₳{{ humanNumber($allTimeFundingPerRound->dataAda?->sum()) }}
                            </span>
                        </div>
                        <div class="flex flex-wrap gap-1 text-sm font-normal flex-nowrap leading-2">
                            <span>
                    ...
                    <div class="w-full min-w-full overflow-hidden">
                        @if( $allTimeFundingPerRound->dataAda?->count() > 1 )
                        <div class="relative w-full xl:w-48">
                            <x-catalyst.users.chart-per-fund dataType="currency" :labels="$allTimeFundingPerRound->labels" :data="$allTimeFundingPerRound->dataAda"></x-catalyst.users.chart-per-fund>
                        </div>
                        @else
                        <div class="inline-flex min-w-[10rem]">
                            <div class="relative z-0 inline-flex rounded-md shadow-sm">
                ...
                <div class="border border-teal-600 -mt-px -ml-px inline-flex flex-col gap-6 justify-between border-opacity-50 p-4 min-w-15 md:min-w-[13rem] xl:min-w-[initial]">
                    <div class="flex flex-row flex-no-wrap items-center justify-between gap-5 md:justify-start text-blue-dark-500">
                        <div class="flex flex-wrap font-semibold flex-nowrap leading-2">
                            <span class="text-xl font-semibold xl:text-3xl leading-2">
                                ₳{{ humanNumber($allTimeAwardedPerRound->dataAda?->sum()) }}
                            </span>
                        </div>
                        <div class="flex flex-wrap gap-1 text-sm font-normal flex-nowrap leading-2">
                            <span>
                    ...
                    <div class="w-full min-w-full overflow-hidden">
                        @if( $allTimeAwardedPerRound->dataAda?->count() > 1 )
                        <div class="relative w-full xl:w-48">
                            <x-catalyst.users.chart-per-fund dataType="currency" :labels="$allTimeAwardedPerRound->labels" :data="$allTimeAwardedPerRound->dataAda"></x-catalyst.users.chart-per-fund>
                        </div>
                        @else
                        <div class="inline-flex min-w-[10rem]">
                            <div class="relative z-0 inline-flex rounded-md shadow-sm">
                ...
                <div class="border border-teal-600 -mt-px -ml-px inline-flex flex-col gap-6 justify-between border-opacity-50 p-4 min-w-15 md:min-w-[13rem] xl:min-w-[initial]">
                    <div class="flex flex-row flex-no-wrap items-center justify-between gap-5 md:justify-start text-blue-dark-500">
                        <div class="flex flex-wrap font-semibold flex-nowrap leading-2">
                            <span class="text-xl font-semibold xl:text-3xl leading-2">
                                ₳{{humanNumber($allTimeReceivedPerRound->dataAda?->sum())}}
                            </span>
                        </div>
                        <div class="flex flex-wrap gap-1 text-sm font-normal flex-nowrap leading-2">
                            <span>
                    ...
                    <div class="w-full min-w-full overflow-hidden">
                        @if( $allTimeReceivedPerRound->dataAda?->count() > 1 )
                        <div class="relative w-full xl:w-48">
                            <x-catalyst.users.chart-per-fund dataType="currency" :labels="$allTimeReceivedPerRound->labels" :data="$allTimeReceivedPerRound->dataAda"></x-catalyst.users.chart-per-fund>
                        </div>
                        @else
                        <div class="inline-flex min-w-[10rem]">
                            <div class="relative z-0 inline-flex rounded-md shadow-sm">
