@push('scripts')
    <script src="{{ mix('js/phuffycoin.js') }}" defer></script>
@endpush
<x-public-layout
        ...
        <div class='container'>
            <nav class="justify-end flexflex-row">
                <ul class="flex flex-row justify-end gap-2 text-sm">
                    ...
                    <li class="flow-root menu-item">
                        <a href="{{localizeRoute('phuffycoin-roadmap')}}" class="flex text-white menu-link">
                            <span class="px-1 py-3">
                                {{ $snippets->roadmap}}
                            </span>
                        </a>
    ...
    <section
        id="phuffycoin"
        class="relative text-white bg-transparent section-1 lg:text-xl">
            ...
            <div class="flex flex-col items-center gap-12 md:gap-6 md:gap-0 md:flex-row">
                <div>
                    ...
                    <div class="z-10 flex flex-col max-w-3xl gap-6">
                        ...
                        <div>
                            <p>
                            Blockchain technology creates new opportunities for decentralized decision-making, shared power - and shared responsibility.
                            PHUFFY Coin is free to use, and is a fun way to learn about blockchain concepts like wallets, addresses, NFTs and more.
                            </p>
                        </div>
                ...
                <div class="flex-1">
                    <div class="relative flex items-center justify-center border-0 rounded-sm bg-clip-border card">
                        <div
                            ...
                            <div class="relative flex items-center justify-center font-extrabold rounded-full w-96 h-96 text-teal-600">
                            ...
                            <!-- <div class="text-6xl font-extrabold text-black md:text-7xl">
                                {{humanNumber($mints?->aggregate?->sum?->quantity, 2)}}
                            </div>
    ...
    <section
        ...
        <div class="container">
            <div>
                ...
                <div
                    class="grid grid-cols-1 text-black lg:grid-cols-2">
                    <div x-data="{
                        ...
                        x-show="module === null"
                        @closemodule.window="module=null" x-transition>
                            ...
                            @if(!$user?->has_lido_nft)
                                <div class="flex items-center md:max-w-xs lg:max-w-none">
                                    <div class="flex flex-col flex-auto gap-2">
                                        ...
                                        <div class="text-xl">
                                            <a class="text-white hover:text-gray-300"  href="{{route('how-to-stake-ada')}}">
                                    ...
                                    <div class="p-4 bg-black bg-opacity-40">
                                        <h3>
                                            ...
                                            @if($user->meta_data->delegation_length > 0)
                                                <span>
                                                    for <span class="text-2xl font-bold text-phuffy-500">{{$user->meta_data->delegation_length}}</span> Epochs
                                                </span>
                                            @endif
                                            <span>!</span>
                                        </h3>
                                        @if($txs)
                                            ...
                                            <div class="w-full overflow-auto text-white bg-gray-900 bg-opacity-25 rounded-md">
                                                    ...
                                                    <div class="flex flex-col">
                                                        <div class="min-w-full -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                                            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                                                                <x-portal.txs-table :txs="$txs->filter(fn($tx) => $tx->type === 'reward' )" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div
                        ...
                        <div class="flex flex-row items-center justify-between w-full gap-2 text-right">
                            ...
                            @else
                                <div class="flex items-start flex-shrink-0 text-left md:h-20 md:w-20">
                                    <span class="font-extrabold leading-none text-gray-600 text-7xl mix-blend-multiply font-display">
                                        2
                                    </span>
                                </div>
                            @endif
                        ...
                        @else
                            <div>
                                <h3 class="text-4xl md:text-5xl">
                                    and joining <span class="font-bold text-phuffy-800">{{$registeredUsers}}</span> registered PHUFFY Coiners using
                    ...
                    <div
                        ...
                        <div class="flex flex-row items-center justify-between w-full gap-2 text-right">
                            @if($user?->has_lido_nft)
                                <div class="flex items-start flex-shrink-0 text-left md:h-12 md:w-20">
                                    <span
                                        class="text-5xl font-extrabold leading-none text-white font-display">4</span>
                                </div>
                            @else
                                <div class="flex items-start flex-shrink-0 text-left md:h-20 md:w-20">
                                    <span
                                        class="font-extrabold leading-none text-white text-7xl font-display">4</span>
                                </div>
                            @endif
                            <div>
                                <h3 class="text-5xl font-semibold text-right">
            ...
            <div class="container">
                <div class="md:grid md:grid-cols-5">
                    <div class="col-span-1">
                        <div class="w-1/2 p-8 pt-0 m-auto text-center align-top h-1/2 md:w-full md:h-full text-phuffy-500">
                    ...
                    <div class="col-span-4 text-xl">
                        ...
                        <p>
                            After Jan 1, new delegators can join anytime and will get PHUFFY whenever LIDO mints a block.
    ...
    <section
        id="current-campaign"
        class="relative py-16 section3 lg:text-xl bg-phuffy-600">
                ...
                <div class="overflow-hidden bg-white rounded-sm md:col-span-5">
                    <div class="py-3">
                        <h2 class="flex flex-col gap-1 p-0 px-6 pt-2 mb-0 text-3xl md:text-5xl text-teal-900 md:flex-row md:items-center">
                            ...
                            <svg class="flex-shrink-0 mr-1.5 w-4 h-4"
                    ...
                    <div class="grid grid-cols-2 gap-3 mt-8 lg:mt-0">
                        <div class="flex flex-col justify-center col-span-1 px-8 py-8 text-center bg-phuffy2-500">
                            <div class="text-3xl font-extrabold">
                                {{$campaign?->metrics?->wallets?->participating ?? '-'}} / {{$registeredUsers ?? '-'}}
                            </div>
                            <div class="text-sm">
                        ...
                        <div class="flex flex-col justify-center col-span-1 px-8 py-8 text-center bg-phuffy2-500">
                            <div class="text-3xl font-extrabold">
                                {{$campaign?->metrics?->phuffy?->participating ?? '-'}} / {{$campaign?->metrics?->phuffy?->eligible ?? '-'}}
                            </div>
                            <div class="text-sm">
                                <span class="block">Participating / Eligible</span>
                                <span class="block font-extrabold uppercase">PHUFFY</span>
                            </div>
                        </div>

                        <div class="grid grid-cols-2 col-span-2 gap-5 p-6 text-left bg-phuffy2-500">
                            <div class="text-4xl font-extrabold md:text-7xl">
                                <span>{{humanNumber($mints?->aggregate?->sum?->quantity, 2)}}</span>
                            </div>
                            <div class="text-2xl md:text-3xl">
                                <span class="font-bold font-display">PHUFFY </span>minted to date
                            </div>
                        </div>
                        <div class="flex flex-col justify-center col-span-2 p-6 text-left bg-phuffy2-500">
                            <div class="text-3xl font-extrabold">
                                <span class="font-display">Activities</span>
                            </div>
                            <div class="text-sm max-h-[15rem] overflow-y-auto">
                                <div>
                                    <ul role="list" class="divide-y divide-primary-1000">
                                        <li class="py-4">
...
{{--                                                        <p class="text-sm text-gray-50">1h</p>--}}
{{--                                                    </div>--}}
                                                    <p class="text-sm">
                ...
                <div class="col-span-4">
                    ...
                    <div class="flex flex-row w-full gap-16 mt-6 text-teal-800">
                        <div class="flex flex-col justify-center gap-2">
                            <div class="flex items-center justify-center w-48 h-48 p-4 font-extrabold rounded-full bg-opacity-20 bg-primary-600 text-teal-700">
                        ...
                        <div class="block w-full overflow-clip">
                            <div class="flex flex-row gap-8 overflow-clip shrink-0">
                                <div class="w-48 h-48 p-6 text-3xl font-bold text-center border-8 border-dashed rounded-md border-primary-800">
                                    your favorite cause here!
                                </div>
                                <div class="w-48 h-48 p-6 text-3xl font-bold text-center border-8 border-dashed rounded-md border-primary-800"></div>
                                <div class="w-48 h-48 p-6 text-3xl font-bold text-center border-8 border-dashed rounded-md border-primary-800"></div>
                                <div class="w-48 h-48 p-6 text-3xl font-bold text-center border-8 border-dashed rounded-md border-primary-800"></div>
                            </div>
                        </div>
    ...
    <section
        id="faqs"
        class="relative py-12 text-white section-6 lg:text-xl md:py-16">
        <div class="container">
    ...
    <section
        class="relative py-16 text-white border-b border-primary-700 bg-primary-1000 section-7 lg:text-xl">
        <div class="container relative">
            ...
            <div class="grid grid-cols-1 gap-6 mb-16 sm:grid-cols-2 lg:grid-cols-3">
                <div
                    class="relative flex flex-col gap-6 p-6 rounded-sm shadow bg-clip-border text-teal-900 bg-phuffy-500">
                    <div class="flex flex-col h-full gap-4">
                        ...
                        <!-- wallet -->
                        <div
                            class="flex flex-col w-full gap-4 px-6 py-4 mt-auto text-white rounded-sm bg-gradient-to-tl to-primary-800 via-primary-600 from-accent-800">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="text-xl font-semibold">
                                        {{$wallets?->treasurer?->balance}} ADA
                                    </div>
                                </div>
                                <div>
                                    <h3 class="text-xs font-semibold text-gray-300">In Circulation</h3>
                                    <div class="text-xl font-semibold">
                                        {{humanNumber($mints?->aggregate?->sum?->quantity, 2)}} PHUFFY
                                    </div>
                                </div>
                                <div class="col-span-2">
                                    ...
                                    <div class="flex flex-col w-full">
                                        <div class="w-full min-w-full -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                            <div class="w-full py-2 overflow-auto sm:px-6 lg:px-8">
                                                <x-portal.txs-table :txs="$wallets?->treasurer?->txs"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div
                    ...
                    <div class="flex flex-col h-full gap-4">
                        ...
                        <p class="text-black">
                            The Governor only holds PHUFFY (and required minimum ADA).
                            When votes are cast, they go here.
                        </p>

                        <!-- wallet -->
                        <div
                            class="flex flex-col w-full gap-4 px-6 py-4 mt-auto text-white rounded-sm bg-gradient-to-tl to-primary-800 via-primary-600 from-accent-800">
                            <h3 class="text-sm font-semibold">Governor Wallet</h3>

                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <h3 class="text-xs font-semibold text-gray-300">Balance</h3>
                                    <div class="text-xl font-semibold">
                                        {{$wallets?->governor?->balance}} ADA
                                    </div>
                                </div>
                                <div class="col-span-2">
                                    <h3 class="text-xs text-gray-300">Address:</h3>
                                    <div class="text-base font-bold break-all">
                                        {{config('cardano.mint.addresses.governor')}}
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="flex flex-col">
                                        <div class="min-w-full -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                            <div class="py-2 overflow-auto sm:px-6 lg:px-8">
                                                <x-portal.txs-table :txs="$wallets?->governor?->txs"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="text-white bg-gray-900 bg-opacity-25 rounded-sm">
                                ...
                                <div>
                                    <div class="flex flex-col">
                                        <div class="min-w-full -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                            <div class="py-2 overflow-auto sm:px-6 lg:px-8">
                                                <x-portal.txs-table :txs="$wallets?->escrow?->txs"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
